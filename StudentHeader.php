...
<?php
	...
	function createStudentHeader($email, $link)
	{
		...
		$output = $output."<div class='col-sm-1'><button class='btn btn-default' onclick='window.location.href=\"".$link."\";'>Back</button></div>";
		$output = $output."<div class='col-sm-2'><img src='BadCanvas.png'/></div>";
		$output = $output."<div class='col-sm-6'><h1>Bad Canvas</h1></div>";
